...
abstract final class AppStrings {
  ...
  static String get settingsPermissions => _l.settingsPermissions;
  static String get settingsPermissionsAllGranted => _l.settingsPermissionsAllGranted;
  static String settingsPermissionsGrantedOf(int granted, int total) =>
      _l.settingsPermissionsGrantedOf(granted, total);
  static String get settingsPermissionsNoneGranted => _l.settingsPermissionsNoneGranted;
  static String get permissionsTitle => _l.permissionsTitle;
  static String get permissionsGrant => _l.permissionsGrant;
  static String get permissionsGranted => _l.permissionsGranted;
  static String get permissionsNotGranted => _l.permissionsNotGranted;
  static String get permissionsInstallTime => _l.permissionsInstallTime;
  static String get permissionsSectionRuntime => _l.permissionsSectionRuntime;
  static String get permissionsSectionInstallTime => _l.permissionsSectionInstallTime;
  static String get permissionsMicDescription => _l.permissionsMicDescription;
  static String get permissionsPhoneStateDescription => _l.permissionsPhoneStateDescription;
  static String get permissionsNotifications => _l.permissionsNotifications;
  static String get permissionsNotificationDescription => _l.permissionsNotificationDescription;
  static String get permissionsBluetooth => _l.permissionsBluetooth;
  static String get permissionsBluetoothDescription => _l.permissionsBluetoothDescription;
  static String get permissionsInternet => _l.permissionsInternet;
  static String get permissionsInternetDescription => _l.permissionsInternetDescription;
  static String get permissionsNetworkState => _l.permissionsNetworkState;
  static String get permissionsNetworkStateDescription => _l.permissionsNetworkStateDescription;
  static String get permissionsWifiState => _l.permissionsWifiState;
  static String get permissionsWifiStateDescription => _l.permissionsWifiStateDescription;
  static String get permissionsAudioSettings => _l.permissionsAudioSettings;
  static String get permissionsAudioSettingsDescription => _l.permissionsAudioSettingsDescription;
  static String get permissionsForegroundService => _l.permissionsForegroundService;
  static String get permissionsForegroundServiceDescription => _l.permissionsForegroundServiceDescription;
  ...
  static String get rogerDeleteSegment => _l.rogerDeleteSegment;
