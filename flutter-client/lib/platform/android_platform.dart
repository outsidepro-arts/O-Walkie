...
/// Android-only hooks (microphone permission, voice communication audio mode).
abstract final class AndroidPlatform {
  static const _channel = MethodChannel('ru.outsidepro_arts.owalkie.flutter/platform');
  ...
  static Future<bool> requestMicrophonePermission() async {
    ...
    final granted = await _channel.invokeMethod<bool>('requestMicrophonePermission');
    return granted ?? false;
  }
